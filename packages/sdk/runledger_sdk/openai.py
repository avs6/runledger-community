...
def uninstrument_openai() -> None:
    ...
    try:
        ...
        if hasattr(completions_cls, "_rl_original_create"):
            completions_cls.create = completions_cls._rl_original_create  # type: ignore[method-assign]
            del completions_cls._rl_original_create

        if hasattr(async_completions_cls, "_rl_original_create"):
            async_completions_cls.create = async_completions_cls._rl_original_create  # type: ignore[method-assign]
