...
| Observe | Runs list | `STRONG` | `N/A` | `STRONG` | `GAP` | `STRONG` | `STRONG` | `STRONG` | `N/A` | `STRONG` | `STRONG` | `STRONG` | `N/A` | `N/A` | MCP Registry and AI hub pages link directly to Runs. MCP tool calls and model catalog traffic generate runs. GET /analytics/ai-hub-runtime-posture returns run_count_30d. |
