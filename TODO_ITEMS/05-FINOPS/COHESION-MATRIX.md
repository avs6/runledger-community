...
Last updated: 2026-09-01 (05-FINOPS WU-019)
...
|-------------------|----------------|------------|--------------|----------------------------|-------------|--------------|--------------|----------------|-----------------|---------------------|----------|-------------------|-------------|------------|--------------------------|----------------------------|------------------------|------------------|--------------------|---------------------|----------|---------|
| FinOps | Budgets | `STRONG` | `STRONG` | `STRONG` | `STRONG` | `STRONG` | `N/A` | `STRONG` | `STRONG` | `STRONG` | `N/A` | `STRONG` | `STRONG` | `STRONG` | `STRONG` | `PARTIAL` | `PARTIAL` | `STRONG` | `N/A` | `N/A` | `STRONG` | WU-010: Budget Control Build Posture endpoint and emerald card added to all 14 Build pages (Playground, Prompts, Agents, Workflows, Evaluation, Experiments, Replay, Model Scorecards, Runbooks) with budget policy (active, breached, avg utilization), scope context, and spend. 14 cells P→S. Remaining PARTIALs: Optimization opportunities, Optimization simulator. |
| FinOps | Budget detail | `STRONG` | `STRONG` | `STRONG` | `STRONG` | `STRONG` | `N/A` | `STRONG` | `STRONG` | `PARTIAL` | `N/A` | `STRONG` | `STRONG` | `STRONG` | `STRONG` | `PARTIAL` | `PARTIAL` | `STRONG` | `N/A` | `N/A` | `PARTIAL` | 05-FINOPS WU-005 adds Budget Detail Build Posture endpoint (`GET /analytics/budget-detail-build-posture`) and emerald Budget & Build Context card to Playground, Prompts list, Prompt detail, Agents list, Agent detail, Workflows list, Workflow detail, Evaluation studio, Experiments, Replay lab, Replay experiment detail, and Model scorecards. 12 cells P→S. Remaining PARTIALs: Workflow run detail, Optimization opportunities, Optimization simulator, Datasets, Runbooks. |
...
| FinOps | Billing periods | `PARTIAL` | `PARTIAL` | `PARTIAL` | `PARTIAL` | `PARTIAL` | `N/A` | `PARTIAL` | `PARTIAL` | `PARTIAL` | `N/A` | `PARTIAL` | `PARTIAL` | `PARTIAL` | `PARTIAL` | `STRONG` | `PARTIAL` | `PARTIAL` | `N/A` | `N/A` | `PARTIAL` | WU-017: Billing Reconciliation Posture endpoint and emerald card on Billing page with optimization context (billing periods, alert rules, cache savings). Optimization opportunities P→S via optimization context tile with drill-through to Optimization page. Prior: Billing and optimization want to work together. |
...
| FinOps | Chargeback | `PARTIAL` | `PARTIAL` | `PARTIAL` | `PARTIAL` | `STRONG` | `N/A` | `PARTIAL` | `PARTIAL` | `PARTIAL` | `N/A` | `PARTIAL` | `PARTIAL` | `PARTIAL` | `PARTIAL` | `STRONG` | `PARTIAL` | `PARTIAL` | `N/A` | `N/A` | `PARTIAL` | WU-019: Chargeback Attribution Posture endpoint and emerald card on Chargeback page with optimization context (chargeback rules, cache savings). Optimization opportunities P→S via optimization context tile with drill-through to Optimization page. Prior: Chargeback is most cohesive when tied to workflows and improvement programs. |
