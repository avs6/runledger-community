...
| Budget detail | `/budgets/{id}` | `OK` | `OK` | `OK` | `OK` | `OK` | `OK` | `OK` | `PARTIAL` | Collapse into `Budgets` as breach/history detail, not a separate feature. | P5 | `RE-AUDITED: PARTIAL` | `6.4` | Re-audited 2026-08-31 (WU-001, WU-003, WU-004). WU-001 added Org & Access Scope Context card. WU-003 added Budget Detail Observe Posture card to Workspace Dashboard, Analytics Users, User Detail, and Engineering Dashboard. WU-004 added Safety & Governance Context card (amber theme) with approval workflow, alert rules, audit events, governance coverage, and tag attribution. Remaining partial cohesion: Build bridges. |
| Budget overrides | `/budget-overrides` | `PARTIAL` | `OK` | `PARTIAL` | `PARTIAL` | `OK` | `OK` | `PARTIAL` | `PARTIAL` | Collapse into `Budgets` as advanced override workflow. | P5 | `RE-AUDITED: PARTIAL` | `6.6` | Re-audited 2026-08-31 (WU-004). WU-004 added Budget Override Governance Posture endpoint (`GET /analytics/budget-override-governance-posture`) and amber Safety & Governance Context card to Budget Detail with approval workflow context, alert rule coverage, audit events, governance coverage percentage, and tag attribution. All 5 Safety & Governance PARTIAL cells (Approvals, Alert rules, Audit log, Governance pack, Tags) moved to STRONG. Override lifecycle is still partial (not full CRUD), but governance integration is now complete. |
