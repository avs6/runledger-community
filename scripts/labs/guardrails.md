...
Define, test, and enforce content safety policies on AI requests and responses.
Includes custom guardrails with Python-like logic, 13 built-in content filters,
partner integrations, a test playground, and gateway-level enforcement.

*Use an org admin account for configuration, any workspace key for testing.*
...
## During-Call Mode And System Message Skip
...
## Guardrail Bypass And Per-Key Config
...
## What Each Guardrail Type Is For
...
See also: [Governance](./governance.md) for the broader governance framework
that guardrails plug into.
