...
- Seed: `python scripts/run_demo.py full-simulate`
...
- Keep these tabs ready:
  ...
  - `MCP`
  - `Runbooks`
- Keep [guided_demo_scenarios.md](guided_demo_scenarios.md) open for recovery prompts.
...
- [demo-runbook.md](../../../docs/demo-runbook.md)
- [demo-script.md](../../../docs/demo-script.md)
- [demo-asset-bundle.md](../../../docs/demo-asset-bundle.md)
- [guided_demo_scenarios.md](guided_demo_scenarios.md)
- [demo-visual-regression.md](../../../docs/demo-visual-regression.md)
