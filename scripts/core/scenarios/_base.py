...
# The simulation pricing catalog. Loaded from scripts/configs/pricing.yaml so the cost
# of every ingested run matches the catalog that full_simulate imports into RunLedger —
# including your priced local Ollama models. Edit scripts/configs/pricing.yaml to change.
PRICING_FILE = Path(__file__).resolve().parent.parent.parent / "configs" / "pricing.yaml"
...
def _load_pricing() -> None:
    """Populate PRICING / PROVIDER_OF from scripts/configs/pricing.yaml (best-effort)."""
    try:
