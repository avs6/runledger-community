...
```json
{
  "hooks": {
    "pre_run_command": [
      {
        "powershell": "python scripts/mcp/windsurf_hook.py --event pre_run_command",
        "command": "python3 scripts/mcp/windsurf_hook.py --event pre_run_command",
        "show_output": true
      }
    ],
    "post_run_command": [
      {
        "powershell": "python scripts/mcp/windsurf_hook.py --event post_run_command",
        "command": "python3 scripts/mcp/windsurf_hook.py --event post_run_command",
        "show_output": false
      }
    ],
    "pre_mcp_tool_use": [
      {
        "powershell": "python scripts/mcp/windsurf_hook.py --event pre_mcp_tool_use",
        "command": "python3 scripts/mcp/windsurf_hook.py --event pre_mcp_tool_use",
        "show_output": true
      }
    ],
    "post_cascade_response_with_transcript": [
      {
        "powershell": "python scripts/mcp/windsurf_hook.py --event post_cascade_response_with_transcript",
        "command": "python3 scripts/mcp/windsurf_hook.py --event post_cascade_response_with_transcript",
        "show_output": false
      }
    ]
  }
