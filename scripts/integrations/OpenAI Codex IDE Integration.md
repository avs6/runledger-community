    ...
    "SessionStart": [
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": "python scripts/mcp/codex_hook.py --event SessionStart",
    ...
    "SubagentStart": [
      {
        "hooks": [
          {
            "type": "command",
            "command": "python scripts/mcp/codex_hook.py --event SubagentStart",
    ...
    "PreToolUse": [
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": "python scripts/mcp/codex_hook.py --event PreToolUse",
    ...
    "SessionEnd": [
      {
        "hooks": [
          {
            "type": "command",
            "command": "python scripts/mcp/codex_hook.py --event SessionEnd",
            "timeout": 5
          }
        ]
      }
