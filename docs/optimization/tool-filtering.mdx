...
call burns tokens. Two Context Compiler stages give the model **only what's relevant to *this*
request**: keep the tools that matter, and inject the body of the skills that match.
