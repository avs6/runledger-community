...
<CardGroup cols={2}>
  ...
  <Card title="High Availability & Backup" href="/optimization/ha-and-backup">
    Scale the services on demand with Kubernetes; back up every durable store to S3 with a tested restore.
  </Card>
</CardGroup>
