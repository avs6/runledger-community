...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("scope", sa.Text, nullable=False, server_default=sa.text("'workspace'")),  # workspace|end_user
    ...
    op.create_index("ix_retention_policies_active", "retention_policies", ["workspace_id", "is_active"])
