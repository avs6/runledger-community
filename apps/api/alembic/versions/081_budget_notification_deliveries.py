...
def upgrade() -> None:
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["notification_id"], ["budget_notifications.id"], ondelete="CASCADE"),
...
def downgrade() -> None:
    op.drop_index("ix_budget_notification_deliveries_workspace", table_name="budget_notification_deliveries")
    op.drop_index("ix_budget_notification_deliveries_notification", table_name="budget_notification_deliveries")
