...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            "cadence", sa.String(length=32), server_default=sa.text("'daily'"), nullable=False
        ),
        ...
        sa.Column(
            "include_memory_db", sa.Boolean(), server_default=sa.text("true"), nullable=False
        ),
        ...
        sa.Column(
            "encryption_mode",
            sa.String(length=32),
            server_default=sa.text("'server_side'"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "snapshot_type", sa.String(length=32), server_default=sa.text("'full'"), nullable=False
        ),
        sa.Column("bucket", sa.String(length=255), nullable=False),
        sa.Column("prefix", sa.String(length=255), nullable=True),
    ...
    op.create_index(
        "ix_backup_snapshots_workspace_created", "backup_snapshots", ["workspace_id", "created_at"]
    )
