...
class McpServer(Base):
    ...
    transport: Mapped[str] = mapped_column(
        sa.String(16), nullable=False, server_default=sa.text("'http'")
    )
    ...
    discovered_resources: Mapped[list[dict[str, Any]]] = mapped_column(
        JSONB, nullable=False, server_default=sa.text("'[]'")
    )
    discovered_prompts: Mapped[list[dict[str, Any]]] = mapped_column(
        JSONB, nullable=False, server_default=sa.text("'[]'")
    )
    health_status: Mapped[str] = mapped_column(
        sa.String(16), nullable=False, server_default=sa.text("'unknown'")
    )
...
class McpToolCall(Base):
    ...
    status: Mapped[str] = mapped_column(
        sa.String(16), nullable=False, server_default=sa.text("'success'")
    )
