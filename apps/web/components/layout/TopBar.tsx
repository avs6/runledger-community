...
export default function TopBar() {
  ...
  const wsDropdown = mounted && wsMenuOpen && dropdownPos ? createPortal(
    <div
      ref={dropdownRef}
      className="fixed w-64 rounded-xl border border-slate-200 bg-[#f8fafc] py-1.5 shadow-xl dark:border-[#292c34] dark:bg-[#1b1e27]"
        ...
        <div className="relative">
          ...
          {userMenuOpen && (
            <>
              ...
              <div className="absolute right-0 top-full z-50 mt-1 w-56 rounded-xl border border-slate-200 bg-[#f8fafc] py-1.5 shadow-lg dark:border-[#292c34] dark:bg-[#1b1e27]">
