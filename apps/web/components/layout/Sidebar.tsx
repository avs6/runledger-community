...
const buildNav = [
  ...
  { href: '/evaluation', label: 'Evaluation Studio', icon: FlaskConical },
...
export default function Sidebar() {
  ...
  return (
    <aside className="flex h-full w-60 min-h-0 flex-col overflow-hidden border-r border-slate-200 bg-[#eef3f8]/95 px-3 py-4 backdrop-blur-xl dark:border-[#252830] dark:bg-[#151821]">
