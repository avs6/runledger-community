    ...
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-semibold tracking-tight text-slate-900 dark:text-white">Vector Stores</h1>
            <p className="mt-0.5 text-sm text-slate-500 dark:text-slate-400">Register, monitor, and manage Qdrant-backed knowledge bases for RAG and semantic search.</p>
          </div>
        </div>
