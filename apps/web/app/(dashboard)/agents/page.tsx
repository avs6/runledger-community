    ...
    <div className="space-y-3">
      ...
      <div className="flex flex-wrap items-center justify-between gap-2">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-semibold tracking-tight text-slate-950 dark:text-white">Agent Registry</h1>
            <p className="mt-0.5 text-sm text-slate-500 dark:text-slate-400">Register, monitor, and govern your AI agents.</p>
          </div>
        </div>
