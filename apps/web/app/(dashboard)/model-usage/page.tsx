  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <h1 className="font-display text-3xl font-semibold tracking-[-0.05em] text-slate-950 dark:text-white">Model Usage</h1>
        ...
        <Link
          ...
          className="inline-flex items-center gap-1 rounded-xl border border-blue-200 bg-blue-50 px-3 py-2 text-sm font-semibold text-blue-700 transition-colors hover:bg-blue-100 dark:border-blue-800 dark:bg-blue-900/40 dark:text-blue-300 dark:hover:bg-blue-800/50"
        >
          ...
          return (
            <Link
              ...
              className={`rounded-xl px-3 py-1.5 text-xs font-semibold transition ${
                active ? 'bg-blue-600 text-white shadow-sm' : 'border border-slate-200 bg-white text-slate-600 hover:bg-blue-50 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300 dark:hover:bg-slate-700'
              }`}
            >
              {scopeLabel(scope)}
            </Link>
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        {[
          ...
          <div key={title} className="rounded-2xl border border-slate-200 bg-white/90 p-5 shadow-sm dark:border-slate-700 dark:bg-slate-800/90">
            <div className="flex items-start justify-between gap-3">
              <div>
                <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-slate-500 dark:text-slate-400">{title}</p>
                <p className="mt-2 font-display text-3xl font-semibold tracking-[-0.045em] text-slate-950 dark:text-white">{value}</p>
                <p className="mt-1 text-xs text-slate-500 dark:text-slate-400">{sub}</p>
              </div>
              <div className="rounded-xl bg-blue-50 p-2.5 text-blue-700 dark:bg-blue-900/40 dark:text-blue-300">
      ...
      {gatewayPosture && (
        <div className="rounded-2xl border border-violet-200 bg-violet-50/60 p-5 shadow-sm dark:border-violet-800 dark:bg-violet-950/30">
          <div className="flex items-start justify-between gap-3">
            <div>
              <p className="text-[11px] font-bold uppercase tracking-[0.16em] text-violet-700 dark:text-violet-400">Gateway & Intelligence Context</p>
              <h2 className="mt-1 text-lg font-semibold tracking-[-0.03em] text-slate-950 dark:text-white">
          ...
          <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4">
            <div className="rounded-lg bg-white/80 p-3 shadow-sm dark:bg-slate-800/60">
              <p className="text-xs font-medium text-slate-500">Routes</p>
              <p className="mt-2 font-display text-3xl font-semibold tracking-[-0.045em] text-slate-950 dark:text-white">{gatewayPosture.gateway_context.active_routes}</p>
            ...
            <div className="rounded-lg bg-white/80 p-3 shadow-sm dark:bg-slate-800/60">
              ...
              <p className="mt-2 font-display text-3xl font-semibold tracking-[-0.045em] text-slate-950 dark:text-white">{gatewayPosture.gateway_context.distinct_models}</p>
            ...
            <div className="rounded-lg bg-white/80 p-3 shadow-sm dark:bg-slate-800/60">
              ...
              <p className="mt-2 font-display text-3xl font-semibold tracking-[-0.045em] text-slate-950 dark:text-white">{gatewayPosture.investigation_context.runs_30d}</p>
            ...
            <div className="rounded-lg bg-white/80 p-3 shadow-sm dark:bg-slate-800/60">
              ...
              <p className="mt-2 font-display text-3xl font-semibold tracking-[-0.045em] text-slate-950 dark:text-white">{gatewayPosture.tag_context.active_tags}</p>
              <p className="mt-1 text-xs text-slate-500">{gatewayPosture.tag_context.tags} total</p>
            </div>
          </div>
          <div className="mt-3 flex flex-wrap gap-2 text-xs">
            <Link href="/gateway" className="rounded-full bg-violet-100 px-3 py-1 font-medium text-violet-700 hover:bg-violet-200 transition-colors dark:bg-violet-900/40 dark:text-violet-300 dark:hover:bg-violet-800/50">Model Gateway</Link>
            <Link href="/provider-profiles" className="rounded-full bg-violet-100 px-3 py-1 font-medium text-violet-700 hover:bg-violet-200 transition-colors dark:bg-violet-900/40 dark:text-violet-300 dark:hover:bg-violet-800/50">Provider Profiles</Link>
            <Link href="/guardrails" className="rounded-full bg-violet-100 px-3 py-1 font-medium text-violet-700 hover:bg-violet-200 transition-colors dark:bg-violet-900/40 dark:text-violet-300 dark:hover:bg-violet-800/50">Guardrails</Link>
            <Link href="/rate-limits" className="rounded-full bg-violet-100 px-3 py-1 font-medium text-violet-700 hover:bg-violet-200 transition-colors dark:bg-violet-900/40 dark:text-violet-300 dark:hover:bg-violet-800/50">Rate Limits</Link>
            <Link href="/runs" className="rounded-full bg-violet-100 px-3 py-1 font-medium text-violet-700 hover:bg-violet-200 transition-colors dark:bg-violet-900/40 dark:text-violet-300 dark:hover:bg-violet-800/50">Runs</Link>
            <Link href="/request-flow" className="rounded-full bg-violet-100 px-3 py-1 font-medium text-violet-700 hover:bg-violet-200 transition-colors dark:bg-violet-900/40 dark:text-violet-300 dark:hover:bg-violet-800/50">Request Flow</Link>
            <Link href="/request-explorer" className="rounded-full bg-violet-100 px-3 py-1 font-medium text-violet-700 hover:bg-violet-200 transition-colors dark:bg-violet-900/40 dark:text-violet-300 dark:hover:bg-violet-800/50">Request Explorer</Link>
            <Link href="/tags" className="rounded-full bg-violet-100 px-3 py-1 font-medium text-violet-700 hover:bg-violet-200 transition-colors dark:bg-violet-900/40 dark:text-violet-300 dark:hover:bg-violet-800/50">Tags</Link>
      ...
      {modelBudgets && (
        <div className="rounded-2xl border border-emerald-200 bg-emerald-50/60 p-5 shadow-sm dark:border-emerald-800 dark:bg-emerald-950/30">
          <div className="flex items-start justify-between gap-3">
            <div>
              <p className="text-[11px] font-bold uppercase tracking-[0.16em] text-emerald-700 dark:text-emerald-400">FinOps Model Budget Utilization</p>
              <h2 className="mt-1 text-lg font-semibold tracking-[-0.03em] text-slate-950 dark:text-white">
                {modelBudgets.active_model_budgets} active model budgets
              </h2>
            </div>
            <Link href="/model-budgets" className="text-xs font-semibold text-emerald-700 hover:underline dark:text-emerald-400">Manage model budgets</Link>
          </div>
          <div className="mt-4 grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
            <div className="rounded-2xl border border-slate-200 bg-white/90 p-5 shadow-sm dark:border-slate-700 dark:bg-slate-800/90">
              <div className="flex items-start justify-between gap-3">
                <div>
                  <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-slate-500">Model Budgets</p>
                  <p className="mt-2 font-display text-3xl font-semibold tracking-[-0.045em] text-slate-950 dark:text-white">{modelBudgets.active_model_budgets}</p>
                  <p className="mt-1 text-xs text-slate-500">{modelBudgets.total_model_budgets} total</p>
                </div>
                <div className="rounded-xl bg-emerald-50 p-2.5 text-emerald-700 dark:bg-emerald-900/40 dark:text-emerald-300"><Wallet className="h-5 w-5" /></div>
              </div>
            </div>
            <div className="rounded-2xl border border-slate-200 bg-white/90 p-5 shadow-sm dark:border-slate-700 dark:bg-slate-800/90">
              <div className="flex items-start justify-between gap-3">
                <div>
                  ...
                  <p className="mt-2 font-display text-3xl font-semibold tracking-[-0.045em] text-slate-950 dark:text-white">{modelBudgets.billing_periods}</p>
                  <p className="mt-1 text-xs text-slate-500">{modelBudgets.open_billing_periods} open</p>
                </div>
                <div className="rounded-xl bg-emerald-50 p-2.5 text-emerald-700 dark:bg-emerald-900/40 dark:text-emerald-300"><DollarSign className="h-5 w-5" /></div>
              </div>
            </div>
            <div className="rounded-2xl border border-slate-200 bg-white/90 p-5 shadow-sm dark:border-slate-700 dark:bg-slate-800/90">
              <div className="flex items-start justify-between gap-3">
                <div>
                  ...
                  <p className="mt-2 font-display text-3xl font-semibold tracking-[-0.045em] text-slate-950 dark:text-white">{modelBudgets.chargeback_rules}</p>
                  <p className="mt-1 text-xs text-slate-500">attribution rules</p>
                </div>
                <div className="rounded-xl bg-emerald-50 p-2.5 text-emerald-700 dark:bg-emerald-900/40 dark:text-emerald-300"><Activity className="h-5 w-5" /></div>
              </div>
            </div>
            <div className="rounded-2xl border border-slate-200 bg-white/90 p-5 shadow-sm dark:border-slate-700 dark:bg-slate-800/90">
              <div className="flex items-start justify-between gap-3">
                <div>
                  ...
                  <p className="mt-2 font-display text-3xl font-semibold tracking-[-0.045em] text-slate-950 dark:text-white">
                ...
                <div className="rounded-xl bg-emerald-50 p-2.5 text-emerald-700 dark:bg-emerald-900/40 dark:text-emerald-300"><Cpu className="h-5 w-5" /></div>
              </div>
            </div>
          </div>
          {modelBudgets.models.filter(m => m.budget_limit_usd !== null).length > 0 && (
            <div className="mt-4 overflow-x-auto">
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-y border-emerald-200 bg-emerald-50/80 dark:border-emerald-800 dark:bg-emerald-950/40">
                    {['Model', 'Spend (30d)', 'Requests', 'Budget Limit', 'Utilization', 'Action', 'Status'].map(h => (
                      <th key={h} className="px-4 py-2 text-left text-xs font-semibold uppercase tracking-[0.12em] text-emerald-700 dark:text-emerald-400">{h}</th>
                    ))}
                  </tr>
                </thead>
                  ...
                  {modelBudgets.models.filter(m => m.budget_limit_usd !== null).map(m => {
                    ...
                    return (
                      <tr key={m.model} className="hover:bg-emerald-50/40 dark:hover:bg-emerald-900/20">
                        <td className="px-4 py-2 font-semibold text-slate-950 dark:text-white">{m.model}</td>
                        ...
                        <td className="px-4 py-2">
                          <span className={`rounded-full px-2 py-0.5 text-[10px] font-semibold ${m.is_active ? 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/40 dark:text-emerald-300' : 'bg-slate-100 text-slate-500 dark:bg-slate-700 dark:text-slate-400'}`}>
      ...
      <Card className="border-slate-200 bg-white/90 shadow-sm dark:border-slate-700 dark:bg-slate-800/90">
        <CardHeader>
      ...
      <Card className="overflow-hidden border-slate-200 bg-white/90 shadow-sm dark:border-slate-700 dark:bg-slate-800/90">
        <CardHeader>
                ...
                {models.map((model) => {
                  ...
                  return (
                    <tr key={model.model} className="hover:bg-blue-50/40 dark:hover:bg-slate-800/40">
                      <td className="px-5 py-3 font-semibold text-slate-950 dark:text-white">{model.model}</td>
                      ...
                      <td className="px-5 py-3 font-mono text-xs font-semibold">
                        {percent(quality)}
                        <span className="ml-2 rounded-full bg-slate-100 px-1.5 py-0.5 text-[10px] font-medium text-slate-500 dark:bg-slate-700 dark:text-slate-400">
                          {qualityLabel}
                        </span>
                      </td>
                    </tr>
                ...
                {routes.map((route) => {
                  ...
                  return (
                    <tr key={route.key} className="align-top hover:bg-blue-50/40 dark:hover:bg-slate-800/40">
                      <td className="px-5 py-3 font-semibold text-slate-950 dark:text-white">{route.route}</td>
                      <td className="px-5 py-3">
                        <div className="font-semibold text-slate-800 dark:text-slate-200">{route.model}</div>
                        <div className="text-xs text-slate-500">{route.provider} / {route.requests.toLocaleString()} requests</div>
                      </td>
                      <td className="max-w-md px-5 py-3 text-slate-600 dark:text-slate-300">{routeReason(route)}</td>
